...
public class ChainedTextArea extends TextArea {
    ...
    public ChainedTextArea(String label, String initialValue, String placeholder) {
        super(label, initialValue, placeholder);
    }

    public ChainedTextArea(ValueChangeListener<? super ComponentValueChangeEvent<TextArea, String>> listener) {
        super(listener);
    }

    public ChainedTextArea(
            String label,
            ValueChangeListener<? super ComponentValueChangeEvent<TextArea, String>> listener) {
        super(label, listener);
    }

    public ChainedTextArea(String label, String initialValue, ValueChangeListener<? super ComponentValueChangeEvent<TextArea, String>> listener) {
    ...
    public ChainedTextArea(String label) {

        super(label);
    }

    public ChainedTextArea(String label, String placeholder) {
