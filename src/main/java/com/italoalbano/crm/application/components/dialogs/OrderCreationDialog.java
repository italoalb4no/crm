...
public class OrderCreationDialog extends CustomDialog {
    ...
    @Autowired
    public OrderCreationDialog(CrmService crmService) {
        super(
                false,
                false,
                true,
    ...
    private void customerSection() {
        ...
        Button newCustomerBtn = new Button(
                ...
                click -> {
                    CustomerCreationDialog customerCreationDialog = new CustomerCreationDialog(this.crmService);
        ...
        comboBox.setItems(filter, this.crmService.getCustomerService().getAllCustomers());
        ...
        Button refreshBtn = new Button(
                ...
                click -> comboBox
                        .setItems(
                                filter,
                                this.crmService.getCustomerService().getAllCustomers()
                        )
        );
